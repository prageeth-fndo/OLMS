...
// Secure query for unread messages
if (isset($_SESSION['teacher'])) {
    $stmt = $link->prepare("SELECT * FROM message WHERE rusername = ? AND read1 = ?");
    $read_status = 'n';
    $stmt->bind_param("ss", $_SESSION['teacher'], $read_status);
    $stmt->execute();
    $res = $stmt->get_result();
    $not = $res->num_rows;
    $stmt->close();
			...
			<div class="left-sidebar">
				...
				<div class="profile">
					<div class="profile-pic">
						<?php
                        $stmt = $link->prepare("SELECT photo FROM t_registration WHERE username = ?");
					...
					<div class="profile-info text-center">
						<span>Welcome!</span>
						<h2><?php echo htmlspecialchars($_SESSION["teacher"]); ?></h2>
					</div>
				</div>
							...
							<li class="dropdown">
                                ...
                                while ($row = $res->fetch_assoc()) {
                                    ...
                                    <a href="" class="dropdown-toggle" data-toggle="dropdown">
                                        ...
                                        <span><?php echo htmlspecialchars($_SESSION["teacher"]); ?></span>
                                    </a>
                                    <?php
                                }
                                $stmt->close();
								...
								<ul class="dropdown-menu">
									<li class="user-header text-center">
                                        ...
                                        $stmt->close();
                                        ?>
										<p><?php echo htmlspecialchars($_SESSION["teacher"]); ?> - Teacher</p>
									</li>
