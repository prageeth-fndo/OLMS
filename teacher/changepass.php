            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    if (isset($_POST["submit"])) {
                        ...
                        // SQLi fixed
                        $stmt = $link->prepare("SELECT password FROM t_registration WHERE username = ?");
                        ...
                        if ($cpass != $pass) {
                            ...
                            if ($npass == $conpass) {
                                ...
                                // SQLi fixed
                                $stmt = $link->prepare("UPDATE t_registration SET password = ? WHERE username = ?");
                                $stmt->bind_param("ss", $npass, $_SESSION["teacher"]);
                                $stmt->execute();
                                $stmt->close();
                                ?>
