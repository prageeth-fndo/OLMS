	...
	<div class="dashboard-content">
        ...
        <?php
            ...
            if (isset($_POST["submit"])) {
                ...
                //SQLi fixed
                $stmt = $link->prepare("INSERT INTO add_book (booksname, imagepath, bauthorname, bpubname, bpurcdate, bprice, bquantity, bavailability, username, filepath) 
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");        
                $stmt->bind_param("sssssdisss", $_POST['booksname'], $imagepath, $_POST['bauthorname'], $_POST['bpubname'], $_POST['bpurcdate'], $_POST['bprice'], $_POST['bquantity'], $_POST['bavailability'], $_SESSION['username'], $filepath);
                if ($stmt->execute()) {
