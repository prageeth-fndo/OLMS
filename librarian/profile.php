						...
						<div class="col-md-3">
                            ...
                            <?php 
                                if (isset($_POST["submit"])) {
                                    ...
                                    $stmt = $link->prepare("UPDATE lib_registration SET photo = ? WHERE username = ?");
						...
						<div class="col-md-7 ml-30">
                            ...
                            <?php
                               if (isset($_POST["update"])){
                                $stmt = $link->prepare("UPDATE lib_registration SET name = ?, phone = ?, address = ? WHERE username = ?");
                                $stmt->bind_param("ssss", $_POST['name'], $_POST['phone'], $_POST['address'], $_SESSION['username']);
                                $stmt->execute();
